...
@section('page-subtitle', 'Ubah data foto galeri')
...
<div class="form-card">
    <form action="{{ route('admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('caption') is-invalid @enderror" id="caption" name="caption" rows="3">{{ old('caption', $gallery->caption) }}</textarea>
            @error('caption')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @if($gallery->image)
                <div>
                    <img src="{{ asset('storage/' . $gallery->image) }}" class="current-image" alt="{{ $gallery->title }}">
